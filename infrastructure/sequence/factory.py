...
def create_sequence_service(sequence_definitions: Optional[List[SequenceDefinition]] = None) -> SequenceService:
    """
    ...
    """
    # Create components
    sequence_provider = InMemorySequenceProvider(sequence_definitions=sequence_definitions)
...
def initialize_sequences(sequence_definitions: Optional[List[SequenceDefinition]] = None) -> None:
    """
